...
public class DatasetUtil {
    ...
    public static String[][] dataset2Data(JFreeChart chart, int series) {
        ...
        if (debug && data != null)
            System.out.println("Dataset2Data:data " + data.length + " : " + data[0].length + " data: " + Arrays.toString(data[0]));
        return data;
    }
    ...
    public static String[][] oneSeriesDataset2Data(Chart[] chart, int series) {
        ...
        if (debug)
            System.out.println("oneSeriesDataset2Data:cl: " + data.length + " : " + data[0].length + " series: " + series + " ");
        int k = 0;
    ...
    public static DefaultBoxAndWhiskerCategoryDataset getSubsetColumnStaticsDataset(int[] col, JFreeChart chart) {
        DefaultBoxAndWhiskerCategoryDataset ds = ((DefaultBoxAndWhiskerCategoryDataset) chart.getCategoryPlot().getDataset());
    ...
    public static DefaultCategoryDataset XYDataset2CategoryDataset(XYDataset xydataset) {
        ...
        for (int i = 0; i < xydataset.getSeriesCount(); i++) {
            for (int j = 0; j < xydataset.getItemCount(i); j++) {
                ds.addValue(xydataset.getYValue(i, j), xydataset.getSeriesKey(i), String.valueOf(xydataset.getXValue(i, j)));
            }
        }
        return ds;
    }
